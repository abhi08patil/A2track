...
public class CaptchaVerifierFilter extends OncePerRequestFilter {
	...
	public void doFilterInternal(HttpServletRequest req, HttpServletResponse res,
		...
		if (captchaCaptureFilter.getRecaptcha_response() != null) {
			logger.debug("captchaCaptureFilter: " +captchaCaptureFilter.getRecaptcha_response());
			...
			if (useProxy) {
				...
				logger.debug("remoteAddr: " + systemSettings.getProperty("http.proxyPort"));
				logger.debug("remoteAddr: " + systemSettings.getProperty("http.proxyHost"));
			}
